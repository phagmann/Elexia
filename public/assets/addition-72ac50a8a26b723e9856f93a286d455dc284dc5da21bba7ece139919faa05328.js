function AdditionView(expresion,divID,rowID,colID){
...
AdditionView.prototype.equationMake = function(){
    ...
    for(var l = 0; l < height; l++){
        ...
        for(var w = 0; w < wide; w++){
            ...
            if( l == height - 2 && w == 0){
                ...
                curr_col.innerHTML = "+";
                curr_col.id = this.col_identifier + "_" + l + "_" + w + "_plus";
                ...
                //curr_col.className = "nopadding"
                curr_col.innerHTML = "&nbsp";
                curr_col.id = this.col_identifier + "_" + l + "_" + w + "_plusholder";
                curr_row.appendChild(curr_col);
...
AdditionView.prototype.progress = function(x,y){
    ...
    if(y == this.height){
        ...
        //console.log(x,y,"-",digitX,digitY,this.reminder,"--",this.col_identifier + "_" + y + "_" + x)
...
String.prototype.isLeadingZero = function(pos){
  ...
  function setUpAddition (showID, inputval, valID, subvalID){
    var euq = new AdditionView(document.getElementById(inputval).value, showID, valID, subvalID);
    euq.equationMake();
}

function showAddition (showID, inputval, valID, subvalID){
    var euq = new AdditionView(document.getElementById(inputval).value, showID, valID, subvalID);
    euq.equationMake();
    var curr_x = euq.wide;
