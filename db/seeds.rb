...
User.create(email: "t2@comp.com", first_name: "Jocelyn", last_name: "Smith" , user_code: "jfiP930uq1", password: "testtest", password_confirmation: "testtest", is_teacher: true)


Subject.create(teacher_id: 1, subject_name: "Math", subject_description: "The one with numbers!", url_path: nil)
Subject.create(teacher_id: 4, subject_name: "Math", subject_description: "The one with numbers!", url_path: nil)
...
Book.create(teacher_id: 1, subject_id: 1, book_name: "Advanced Arithmatic", book_description: "4th grade level", url_path: '/books/2', book_weights_string_list: '80,20')
Book.create(teacher_id: 1, subject_id: 1, book_name: "Intro to Varibles", book_description: "5rd grade level", url_path: '/books/3', book_weights_string_list: '80,20')
Book.create(teacher_id: 4, subject_id: 2, book_name: "Advanced Varibles", book_description: "6th grade level", url_path: '/books/4', book_weights_string_list: '80,20')
...
Enrollment.create(teacher_id: 4, student_id: 1, subject_id: 2, book_id: 4)
...
Section.create(teacher_id: 4, subject_id: 2, book_id: 4, section_name: "Section 1", section_description: "Long Division", url_path: nil)
...
Chapter.create(teacher_id: 4, subject_id: 2, book_id: 2, section_id: 2, chapter_name: "Chapter 1", chapter_description: "Meh", url_path: '/chapters/2')
...
Box.create(lesson_id: 1, ordering: 1, title: "Example 1", paragraph_id: 1)
...
Lesson.create(teacher_id: 4, subject_id: 2, book_id: 4, section_id: 2, chapter_id: 2, lesson_name: "What is Division?", lesson_description: "cool stuff!", url_path: nil)
Box.create(lesson_id: 2, ordering: 1, title: "Example 1.5", paragraph_id: 2)
Paragraph.create(box_id: 2, note_type: 5, paragraph_text: "This is a simple test of our system. Your a nerd")
Note.create(box_id: 2, user_id: 1, note_type: 5, text: "I am the Walrus Chuu")
